...
public abstract class Automata {
	 ...
	 * 增加一个转换函数
	 */
	public void addTransfer(String beginStateId, String inputString,
			String endStateId) {
		State beginState = states.get(beginStateId);
		State endState = states.get(endStateId);
		Transition tran = new Transition(beginState, inputString, endState);////修改过  2010-1-10
		beginState.addTransfer(inputString, tran);
		transfers.add(tran);
	}
	...
	public void setStartQ(State startQ) {
		this.startQ = startQ;
	}
	...
	public void setTransfers(List<Transition> transfers) {
