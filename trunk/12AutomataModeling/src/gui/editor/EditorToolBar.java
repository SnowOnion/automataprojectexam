...
import gui.editor.EditorActions.FontStyleAction;
...
import gui.Business.CheckAction;
...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		addSeparator();
		add(editor.bind("Check", new CheckAction(),
		"/gui/images/check.png"));
		addSeparator();
