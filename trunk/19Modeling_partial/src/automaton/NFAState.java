...
/**
 * Create by: huangcd Date: 2009-12-10 Time: 14:16:03
 */
...
public class NFAState<C extends Comparable<C>> implements State
{
    ...
    protected NFAState(String stateID, Set<StateType> types,
            FiniteAutomaton owner)
    {
        this.stateID = stateID;
    ...
    /**
     * add a transition to the transition map, if the specify symbol is already
     * in the map, return false directly; otherwise add the transition to the
     * map and return true.
     * 
     * @param symbol
     * @param state
    ...
    {
        if (!transitionMap.containsKey(symbol)) { return null;
        // log.log(Level.SEVERE, "the symbol \"" + symbol + "\" is not miss",
        // this);
        // throw new UnconvertableException("the symbol \"" + symbol +
        // "\" is not miss");
        }
    ...
    public TreeSet<NFAState> getEpsilonClosure()
    {
        ...
        log.log(Level.INFO, "calculate epsilon closure, result is " + result,
                this);
        result.add(this);
        return result;
    }
    ...
    {
        return "NFAState{" + "stateID='" + stateID + '\'' + ", stateTypes="
                + stateTypes + '}';
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return !(owner != null ? !owner.equals(nfaState.owner)
                : nfaState.owner != null)
                && !(stateID != null ? !stateID.equals(nfaState.stateID)
                        : nfaState.stateID != null);
