...
*/
public class IntersectionUI extends javax.swing.JFrame {
	private JLabel jLabel1;
	private JButton Bt_intersection;
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				IntersectionUI inst = new IntersectionUI();
		...
		try {
			{
				...
				{
					Bt_intersection = new JButton();
					getContentPane().add(Bt_intersection);
					Bt_intersection.setText("\u81ea\u52a8\u673a\u4ea4\u64cd\u4f5c");
					Bt_intersection.setBounds(43, 284, 146, 22);
					Bt_intersection.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent evt) {
							Bt_intersectionActionPerformed(evt);
						}
					});
				}
				{
	...
	private void Bt_intersectionActionPerformed(ActionEvent evt) {
		System.out.println("Bt_intersection.actionPerformed, event="+evt);
		//TODO add your code for Bt_intersection.actionPerformed
		...
		try{
			...
			try {
				intersectionAuto = testAlg.intersectionOP(auto1, auto2);
