...
*/
public class MinUI extends javax.swing.JFrame {
	private JLabel jLabel1;
	private JButton Bt_min;
	...
	*/
		...
		try {
			{
				...
				{
					Bt_min = new JButton();
					getContentPane().add(Bt_min);
					Bt_min.setText("\u81ea\u52a8\u673a\u6700\u5c0f\u5316");
					Bt_min.setBounds(43, 175, 122, 22);
	...
	private void Bt_minActionPerformed(ActionEvent evt) {
		System.out.println("Bt_min.actionPerformed, event="+evt);
		//TODO add your code for Bt_min.actionPerformed
		Automaton minAuto,test;
		try{
			...
			try {
				minAuto = testAlg.minOP(test);
			} catch (NotDFAException e) {
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(null, e.getMessage(),"alert",JOptionPane.ERROR_MESSAGE);;
				return;
			}
			autoFact.writeAutomatonToXml(minAuto, new File(filename_save));
		}catch(Exception e){
