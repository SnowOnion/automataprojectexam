...
public class BasicGraphEditor extends JPanel
{
	...
	static
	{
		mxResources.add("gui/resources/editor");
	}
	...
	public BasicGraphEditor(String appTitle, mxGraphComponent component)
	{
		...
		JScrollPane sc=new JScrollPane(navigator,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
//		navigator.setPreferredSize(new Dimension(200,200));
		
		propertyPanel=new PropertyPanel();
		JScrollPane sc1=new JScrollPane(propertyPanel,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		
		JSplitPane right = new JSplitPane(JSplitPane.VERTICAL_SPLIT, sc,
				sc1);
		...
		JSplitPane content = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, graphComponent,
				right);
