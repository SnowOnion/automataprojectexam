...
/**
 * Create by: huangcd Date: 2009-12-10 Time: 9:48:09
 */
...
public class DFAState<C extends Comparable<C>> implements State
{
    ...
    protected DFAState(String stateID, Set<StateType> types,
    ...
    public DFAState shift(C symbol)
    {
        ...
        // String message = "the symbol \"" + symbol +
        // "\" is not accept by the current " + this;
    ...
    {
        return "DFAState{" + "stateID='" + stateID + '\'' + ", stateTypes="
                + stateTypes + '}';
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return !(owner != null ? !owner.equals(dfaState.owner)
                : dfaState.owner != null)
                && !(stateID != null ? !stateID.equals(dfaState.stateID)
